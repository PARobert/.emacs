...
;; 
;; Description : setup file for title functionality. It inserts a title in the
;; code to makes it easier to read.
;; -----------------------------------------------------------------------------
...
(defun add-dash-line (&optional after)
  ...
  (insert-char ?- (- fill-column (length title-prefix-string)))
  (insert after))
